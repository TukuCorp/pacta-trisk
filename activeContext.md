...
`NEWS.md` (the maintained changelog) and `plans/` (the maintained work
tracker). Per this project's global workflow convention, per-session
...
This file is kept (not deleted) because the project's global workflow
conventions expect an `activeContext.md` to exist at the repo root.
